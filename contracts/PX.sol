...
contract PX is ERC165, ISubscriptionOwner, ERC721URIStorage, Ownable {
    ...
    function getProgressImage(
        ...
        bytes memory svg = abi.encodePacked(
            ...
            pxStorage[tokenId].size.toString(),
            storageUnit,
            ...
            pxStorage[tokenId].usagePercentage.toString(),
    ...
    function getTokenURI(
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            getProgressImage(tokenId, storageUnit),
    ...
    function updateStorageUsage(
        ...
        pxStorage[tokenId].usagePercentage = calculatePercentageDifference(
